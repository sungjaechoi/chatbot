            ...
            {user && (
              <div className="flex items-center gap-2.5 pt-1">
                ...
                <div className="relative" ref={settingsRef}>
                  ...
                  >
                    <svg
                      className={`h-4 w-4 transition-transform duration-300 ${isSettingsOpen ? "rotate-90" : "rotate-0"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      strokeWidth={1.5}
                  ...
                  {isSettingsOpen && (
                    <div
                      className="settings-panel absolute right-0 top-full mt-2 w-56 overflow-hidden rounded-xl"
                      style={{
                        background: "var(--color-paper)",
                        border: "1px solid var(--color-ai-border)",
